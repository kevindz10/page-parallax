  ...
  render() {
  	return(
  		<BrowserRouter basename={'/'} >
		  	<Switch>
				  {/* ruta para componente de HomeChef */}
			  <Route exact path={`${process.env.PUBLIC_URL}/`} component={HomeChef}/>
        	  <Route path={`${process.env.PUBLIC_URL}/home-chef`} component={HomeChef}/>
